...
**✅ بش اسکریپت به صورت خودکار تمومی کار ها رو انجام میده ، (نصب پکیج و کامپایل و ... ) و در اخر تمومی لاگ های سرور هم پاک میکنه تا رد پایی نمونه و کاملا پاک بشه و در نهایت سرویس رو اجرا میکنه ✓**
